...
router.get('/:date', function (req, res, next) {
    ...
    var queryString = "SELECT symbol,name,market_cap,ipoyear,sector,industry,erdate,erdetails,price,pe,eps,industry_return FROM company_tickers_ercal where ((erdate = '" + dateString + "' and erdetails like '%after%') or (erdate = '" + nextDateString + "' and erdetails like '%before%')) and industry_return>=1.5";
